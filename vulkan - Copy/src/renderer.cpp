...
void renderer::_setupLayersAndExtensions()
{
	...
	// results in VK_ERROR_EXTENSION_NOT_PRESENT, not sure exactly why
	// seems to be fine without it?, it looks like it loads without it anyways
	//_instance_extensions.push_back(VK_KHR_SWAPCHAIN_EXTENSION_NAME);
}
...
void renderer::_initInstance() {
	...
	application_info.apiVersion = VK_MAKE_VERSION(1, 0, 13);// 13? 2? ???
...
{
	// something deprecated? its in the debug text at startup
	// refers to replacement of vkGetInstanceProcAddr
