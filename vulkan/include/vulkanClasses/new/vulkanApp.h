...
#include "./new/camera.h"
#include "./new/vulkanTools.h"
#include "./new/vulkanDebug.h"
#include "./new/vulkanShaders.h"
#include "./new/vulkanFramebuffer.h"

#include "./new/vulkanContext.h"
#include "./new/vulkanSwapChain.h"
#include "./new/vulkanTextureLoader.h"
#include "./new/vulkanMeshLoader.h"
#include "./new/vulkanTextOverlay.h"
...
namespace vkx {
    ...
    class vulkanApp : public Context {
    protected:
        vulkanApp(bool enableValidation);
        vulkanApp() : vulkanApp(false) {};
        ~vulkanApp();
