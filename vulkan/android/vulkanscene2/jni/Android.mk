...
PROJECT_FILES := $(wildcard $(LOCAL_PATH)/../../src/vulkanscene2.cpp)
PROJECT_FILES += $(wildcard $(LOCAL_PATH)/../../src/vulkanClasses/*.cpp)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../vulkanClasses/
