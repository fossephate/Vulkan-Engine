...
public:
	...
	VulkanExample() : vkx::vulkanApp(ENABLE_VALIDATION) {
		...
		camera.setTranslation({ -20.0f, -20.0f, -200.0f });
		camera.matrices.projection = glm::perspective(glm::radians(60.0f), (float)size.width / (float)size.height, 0.1f, 512.0f);//, 0.001f, 256.0f);
		zoomSpeed = 2.5f;
		//rotationSpeed = 0.5f;
