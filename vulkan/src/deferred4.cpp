...
public:
	...
	VulkanExample() : vkx::OffscreenExampleBase(ENABLE_VALIDATION) {
		...
		//camera.setProjection(60.0f, (float)size.width / (float)size.height, 0.1f, 256.0f);
	...
	void updateUniformBufferDeferredLights() {
		...
		uboFragmentLights.viewPos = glm::vec4(camera.transform.translation, 0.0f) * glm::vec4(-1.0f, -1.0f, -1.0f, 1.0f);
