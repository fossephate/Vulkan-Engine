...
vkx::TextOverlay::TextOverlay(Context context, uint32_t & framebufferwidth, uint32_t & framebufferheight, vk::RenderPass renderPass)
...
void vkx::TextOverlay::prepareResources() {
...
void vkx::TextOverlay::preparePipeline(vk::RenderPass renderPass) {
...
void vkx::TextOverlay::beginTextUpdate() {
...
void vkx::TextOverlay::addText(std::string text, float x, float y, TextAlign align) {
...
void vkx::TextOverlay::endTextUpdate() {
	vertexBuffer.unmap();
	mapped = nullptr;
}
...
void vkx::TextOverlay::writeCommandBuffer(const vk::CommandBuffer & cmdBuffer) {
