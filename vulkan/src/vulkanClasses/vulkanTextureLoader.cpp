...
vkTools::VulkanTextureLoader::VulkanTextureLoader(vkx::VulkanDevice * vulkanDevice, VkQueue queue, VkCommandPool cmdPool)
{
...
void vkTools::VulkanTextureLoader::loadTexture(std::string filename, VkFormat format, VulkanTexture * texture, bool forceLinear, VkImageUsageFlags imageUsageFlags)
{
...
void vkTools::VulkanTextureLoader::loadCubemap(std::string filename, VkFormat format, VulkanTexture * texture, VkImageUsageFlags imageUsageFlags)
{
	#if defined(__ANDROID__)
		assert(assetManager != nullptr);
...
void vkTools::VulkanTextureLoader::loadTextureArray(std::string filename, VkFormat format, VulkanTexture * texture, VkImageUsageFlags imageUsageFlags)
{
	#if defined(__ANDROID__)
		assert(assetManager != nullptr);
