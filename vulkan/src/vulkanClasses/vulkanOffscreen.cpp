...
void vkx::OffscreenRenderer::destroy() {
	queue.waitIdle();
	device.waitIdle();
	framebuffer.destroy();
...
void vkx::OffscreenRenderer::prepare() {
...
void vkx::OffscreenRenderer::prepareFramebuffer() {
...
void vkx::OffscreenRenderer::prepareSampler() {
	// Create sampler
...
void vkx::OffscreenRenderer::prepareRenderPass() {
