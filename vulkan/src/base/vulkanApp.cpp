...
void vulkanApp::loadMesh(std::string filename, vkMeshLoader::MeshBuffer * meshBuffer, std::vector<vkMeshLoader::VertexLayout> vertexLayout, vkMeshLoader::MeshCreateInfo *meshCreateInfo)
{
	...
	VkCommandBuffer copyCmd = vulkanApp::createCommandBuffer(VK_COMMAND_BUFFER_LEVEL_PRIMARY, false);
...
vulkanApp::VulkanExampleBase(bool enableValidation, PFN_GetEnabledFeatures enabledFeaturesFn)
{
