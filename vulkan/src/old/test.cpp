...
public:
	...
	void loadMesh()
	{
		...
		if (useStaging)
		{
			...
			VkCommandBuffer copyCmd = vulkanApp::createCommandBuffer(VK_COMMAND_BUFFER_LEVEL_PRIMARY, true);
	...
	void loadMeshes()
	{
		vulkanApp::loadMesh(getAssetPath() + "models/plane_z.obj", &meshes.floor, vertexLayout, 512.0f);
	}
